#AUTONAVx Homework 6 Programming Assignment
#Script for implementing a Kalman filter. The "predictState" and "correctState"
#functions were written as part of the assignment, whereas the rest of the
#functions were already written. This code is meant to run on a simulator from
#which it pulls accesses certain variables such as "z", the supposed GPS
#readings which make up the measurement variable. For this reason, it won't
#run on its own in its current state.
